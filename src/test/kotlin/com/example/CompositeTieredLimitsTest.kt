...
class CompositeTieredLimitsTest {
    @Test
    fun `composite limiter caps total requests at sustained limit`() =
        runTest {
    ...
    @Test
    fun `composite limiter respects burst limit within sustained window`() =
        runTest {
    ...
    @Test
    fun `tiered tryAcquire denial comes from the exhausted tier`() =
        runTest {
            ...
            assertTrue(
                denied.retryAfter.inWholeSeconds >= 10,
