...
class RateLimiterTest {
    @Test
    fun `bursty limiter grants permits up to capacity`() =
        runTest {
    ...
    @Test
    fun `bursty limiter blocks when permits exhausted`() =
        runTest {
    ...
    @Test
    fun `tryAcquire returns Denied when no permits available`() =
        runTest {
    ...
    @Test
    fun `smooth limiter spaces out permits evenly`() =
        runTest {
    ...
    @Test
    fun `composite limiter enforces all sub-limiters`() =
        runTest {
