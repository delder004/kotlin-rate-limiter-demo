...
class RoutesTest {
    ...
    private fun validConfigParams(): Parameters = parameters {
    ...
    @Test
    fun `GET returns 200 HTML page shell`() = testApplication {
        application { module() }
    ...
    @Test
    fun `POST simulations with valid form creates handle and patches sim lifecycle`() = testApplication {
    ...
    @Test
    fun `POST simulations with invalid form returns form errors and creates no handle`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
    ...
    @Test
    fun `DELETE simulations stops an existing handle`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
    ...
    @Test
    fun `DELETE simulations returns 404 for missing handle`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
    ...
    @Test
    fun `PATCH simulations with valid form updates running handle preserving id`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
        val created = client.submitForm(url = "/simulations", formParameters = validConfigParams())
        assertEquals(HttpStatusCode.OK, created.status)
    ...
    @Test
    fun `PATCH simulations with invalid form returns form errors and leaves config untouched`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
        val created = client.submitForm(url = "/simulations", formParameters = validConfigParams())
        assertEquals(HttpStatusCode.OK, created.status)
    ...
    @Test
    fun `POST simulations accepts Datastar nested JSON payload`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }

        val response = client.post("/simulations") {
    ...
    @Test
    fun `POST simulations with invalid Datastar JSON returns form errors`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
    ...
    @Test
    fun `PATCH simulations accepts Datastar nested JSON payload`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
        ...
        val response = client.patch("/simulations/${handle.id}") {
            contentType(ContentType.Application.Json)
            setBody(patchBody)
        }
    ...
    @Test
    fun `PATCH simulations applies overflowMode change from running handle`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
    ...
    @Test
    fun `PATCH simulations applies apiTarget change from running handle`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
    ...
    @Test
    fun `PATCH simulations returns 404 for missing handle`() = testApplication {
        val registry = SimulationRegistry()
        application { module(registry) }
        val response = client.submitForm(
