...
enum class LimiterType(val wire: String) {
    ...
    companion object {
        fun fromWire(value: String?): LimiterType? = entries.firstOrNull { it.wire.equals(value, ignoreCase = true) }
    }
}
...
enum class OverflowMode(val wire: String) {
    ...
    companion object {
        fun fromWire(value: String?): OverflowMode? = entries.firstOrNull { it.wire.equals(value, ignoreCase = true) }
    }
}
...
enum class ApiTarget(val wire: String) {
    ...
    companion object {
        fun fromWire(value: String?): ApiTarget? = entries.firstOrNull { it.wire.equals(value, ignoreCase = true) }
    }
}
